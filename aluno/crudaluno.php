...
if(isset($_GET['cadastrar'])){
        ...
        ##codigo SQL
        $sql = "INSERT INTO aluno(nome,endereco,idade,datanascimento,estatus,matricula) 
                VALUES('$nome','$endereco','$idade','$datanascimento','$estatus','$matricula')";
        ...
        if($sqlcombanco->execute())
            {
                echo " <strong>OK!</strong> PARABENS ALUNO
...
if(isset($_POST['update'])){
    ...
    $id = $_POST["id"];
      ...
      ##codigo sql
    $sql = "UPDATE  aluno SET nome= :nome, endereco= :endereco, idade= :idade, datanascimento= :datanascimento, estatus= :estatus, matricula= :matricula  WHERE id= :id ";
